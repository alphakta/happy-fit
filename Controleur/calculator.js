...
if (((YZ.Widget = YZ.Widget || {}), "undefined" == typeof YZ.Widget.isLoaded)) {
  ...
  (YZ.Service = YZ.Service || {}),
    (YZ.Service.IntlService = (function () {
      ...
      var n = {};
      return { parseAndTranslate: a, translate: e, loadTranslations: t };
    })());
  var YZ = YZ || {};
  (YZ.Component = YZ.Component || {}),
    (YZ.Component.Age = function (e, a) {
      ...
      var l = null,
        r = !1;
      return { getValue: t, renderInitialDom: n, isValid: i };
    });
  var YZ = YZ || {};
  (YZ.Component = YZ.Component || {}),
    (YZ.Component.Alert = function () {
      ...
      var i = null;
      return { renderInitialDom: e, show: a, hide: t };
    });
  var YZ = YZ || {};
  (YZ.Component = YZ.Component || {}),
    (YZ.Component.DailyActivity = function (e, a) {
      ...
      var o = null,
        ...
        u = null,
        d = !1;
      return { getValue: t, renderInitialDom: n, isValid: c };
    });
  var YZ = YZ || {};
  (YZ.Component = YZ.Component || {}),
  ...
  (YZ.Component = YZ.Component || {}),
    (YZ.Component.Gender = function (e, a) {
      ...
      var r = "yz-calc-step-gender-" + a.settings.calculatorLabel,
        ...
        o = null,
        s = !1;
      return { getValue: t, renderInitialDom: n, isValid: l };
    });
  var YZ = YZ || {};
  (YZ.Component = YZ.Component || {}),
  ...
  (YZ.Component = YZ.Component || {}),
    (YZ.Component.SportsAutocomplete = function (e, a) {
      ...
      function i(t) {
        l(function () {
          ...
          var c = YZ.Service.IntlService.parseAndTranslate(
              '<div class="yz-separator-line"><div class="yz-separator-icon">' +
                e +
                '</div></div><p class="yz-calc-step-title">{{ calculator.calories_burned.label.enter_exercise }}</p><div class="yz-calc-step-action"><div class="yz-calc-select-group"><select class="yz-calc-select-input"><optgroup label="Beliebteste Aktiviäten">' +
                i +
                '</optgroup><optgroup label="Alle Aktiviäten">' +
                n +
      ...
      var o = null,
        ...
        u = !1,
        d = [];
      return { getValue: t, renderInitialDom: i, isValid: c, getActivity: n };
    });
  var YZ = YZ || {};
  (YZ.Component = YZ.Component || {}),
    (YZ.Component.Weight = function (e, a) {
      ...
      var r = null,
        c = !1;
      return { getValue: t, renderInitialDom: i, isValid: l, getFactor: n };
    });
  var YZ = YZ || {};
  (YZ.Calculator = YZ.Calculator || {}),
    (YZ.Calculator.Base = function (e) {
      ...
      var s = {},
        ...
        m = null,
        y = null;
      return { init: a, getComponent: r, getResultSection: o };
    });
  var YZ = YZ || {};
  (YZ.Calculator = YZ.Calculator || {}),
  ...
  (YZ.Service = YZ.Service || {}),
    (YZ.Service.WidgetManager = (function () {
      ...
      function t(e) {
        var a = e.getElementsByClassName("yz-copyright")[0],
          t = null;
        if (!a)
          throw (
            (n(e),
            Error(
              "Yazio copyright element does not exist. Please add it to the widget code."
            ))
          );
        if (((t = a.getElementsByTagName("a")[0]), !t))
          throw (
            (n(e),
            Error(
              "Yazio copyright link is missing. Please add it to the widget code."
            ))
          );
        if (-1 === a.innerHTML.indexOf("Powered"))
          throw (
            (n(e),
            Error(
              'Yazio copyright notice is not correct. Please do not change the original "Powered by ".'
            ))
          );
        if (-1 === t.innerHTML.indexOf("YAZIO"))
          throw (
            (n(e),
            Error(
              'Yazio copyright notice link is not correct. Please do not change the original "YAZIO".'
            ))
          );
        if (-1 === t.getAttribute("href").indexOf("https://www.yazio.com"))
          throw (
            (n(e),
            Error(
              "Yazio copyright notice link is not correct. Please use the original link."
            ))
          );
      ...
      function n(e) {
        ...
        (a.innerHTML =
          "Could not load calculator. Yazio copyright notice is missing, or not correct. Please see the error console for more information."),
          e.appendChild(a);
      }
      function i(e) {
