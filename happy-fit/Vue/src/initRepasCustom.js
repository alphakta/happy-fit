...
function initRepasRectoCustom(designation, tempsPrepa, listeIngremiam){
  ...
  console.log("ahhhhhhhhhhh")
    ...
    listeIng.id = "liste"
    listeIng.innerHTML = listeIngremiam
        ...
        open.onsuccess = function () {
            ...
            getRepas.onsuccess = function () {
              getRepas.result.forEach(element => {
                  ...
                  {
                    console.log("liste ingré")
                    console.log(element.listeIngredient)
                    console.log(typeof element.designationRepas)
